...
from profanity-detector.controller.v1 import foo_controller

# const vars
__version__ = '0.0.1'
__email__ = 'simonbelete@gmail.com'
__title__ = 'Profanity Detector'
__author__ = 'Simon Belete'
__keywords__ = ''
__repo_name__ = 'Profanity Detector'
__description__ = 'English and Amharic profanity detector'
__project_name__ = 'Profanity Detector'
